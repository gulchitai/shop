...
Route::group(['prefix' => 'caterogies'], function () {
    Route::get('/', \App\Http\Controllers\Caterogy\IndexController::class) -> name('category.index');
    Route::get('/create', \App\Http\Controllers\Caterogy\CreateController::class) -> name('category.create');
    Route::post('/', \App\Http\Controllers\Caterogy\StoreController::class) -> name('category.store');
    Route::get('/{category}/edit', \App\Http\Controllers\Caterogy\EditController::class) -> name('category.edit');
    Route::get('/{category}', \App\Http\Controllers\Caterogy\ShowController::class) -> name('category.show');
    Route::patch('/{category}', \App\Http\Controllers\Caterogy\UpdateController::class) -> name('category.update');
    Route::delete('{category}',\App\Http\Controllers\Caterogy\DeleteController::class) -> name('category.delete');
});
