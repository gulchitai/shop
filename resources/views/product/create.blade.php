        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <form action="{{ route('product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <textarea name="context" class="form-control" cols="30" rows="10" placeholder="Контент"></textarea>
                    </div>
                    <div class="form-group">
                        <input class="form-control"  name="price" type="text" placeholder="Цена">
                    </div>
                    <div class="form-group">
                        <input class="form-control"  name="count" type="text" placeholder="Количество на складе">
                    </div>
                    <div class="form-group">
